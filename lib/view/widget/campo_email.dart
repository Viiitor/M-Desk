...
class CampoEmail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      validator: (valorDigitado) {
        var msnErro = ehVazio(valorDigitado) ?? temArroba(valorDigitado);
        return msnErro;
      },
      decoration: const InputDecoration(
          label: Text('E-mail:'), hintText: 'email@exemplo.com'),
    );
  }
  ...
  String? temArroba(String? valorDigitado) {
    if (!valorDigitado!.contains('@')) return 'E-mail deve possuir "@".';
    return null;
  }
}
